...
MODULE dynho_Integrator

  USE dynho_Parameters, ONLY: NVAR, NFIX, NSPEC, LU_NONZERO
  USE dynho_Global
  IMPLICIT NONE
  PUBLIC
  SAVE
...
!~~~>   Initialize the particular Rosenbrock method selected
   SELECT CASE (ICNTRL(3))
     ...
     CASE (2)
       CALL Ros3
        PRINT * , 'Rosenbrock method inRosenbrockdovvrebbe essere spra 2: ICNTRL)=', ICNTRL(3)
       !PRINT * , 'Rosenbrock method inRosenbrockdovvrebbe essere spra 2: TIN)=',TIN
       !PRINT * , 'Rosenbrock method inRosenbrockdovvrebbe essere spra 2: TOU)=',TOUT
       !PRINT * , 'Rosenbrock method inRosenbrockdovvrebbe essere spra 2: RCNTRL_U)=',RCNTRL_U
       !PRINT * , 'Rosenbrock method inRosenbrockdovvrebbe essere spra 2: ISTATUS_U)=',ISTATUS_U
       !PRINT * , 'Rosenbrock method inRosenbrockdovvrebbe essere spra 2: RSTATUS_U)=',RSTATUS_U
       !PRINT * , 'Rosenbrock method inRosenbrockdovvrebbe essere spra 2: IERR_U)=',IERR_U
    CASE (3)
       CALL Ros4
     CASE (0,4)
       CALL Rodas3
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE dynho_Parameters, ONLY: NVAR, LU_NONZERO
 USE dynho_Global, ONLY: FIX, RCONST, TIME
 USE dynho_Function, ONLY: Fun
 USE dynho_Rates, ONLY: Update_SUN, Update_RCONST
!~~~> Input variables
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE dynho_Parameters, ONLY: NVAR, LU_NONZERO
 USE dynho_Global, ONLY: FIX, RCONST, TIME
 USE dynho_Jacobian, ONLY: Jac_SP, LU_IROW, LU_ICOL
 USE dynho_LinearAlgebra
 USE dynho_Rates, ONLY: Update_SUN, Update_RCONST
!~~~> Input variables
    REAL(kind=dp) :: T, Y(NVAR)
