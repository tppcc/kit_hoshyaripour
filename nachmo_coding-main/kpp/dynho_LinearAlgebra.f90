...
! XX - Vector for output variables
  ...
  XX(3) = (X(3)-JVS(3)*XX(1)-JVS(6)*XX(2))/(JVS(9))
  XX(3) = XX(3)
  XX(2) = XX(2)-JVS(8)*XX(3)
  XX(1) = XX(1)-JVS(4)*XX(2)-JVS(7)*XX(3)
...
END MODULE dynho_LinearAlgebra
