...
contains
  ...
  pure elemental subroutine set_activation(self, activation)
    ...
    select case(trim(activation))
      ...
      case('prelu1')
        self % activation => prelu1
        self % activation_str = 'prelu1'
      case('prelu2')
        self % activation => prelu2
        self % activation_str = 'prelu2'
      case('sigmoid')
      ...
      case('sine')
        ...
        self % activation_prime => sine_prime
        self % activation_str = 'sine'
      case('ini_sine')
        self % activation => ini_sine
        self % activation_prime => ini_sine_prime
        self % activation_str = 'ini_sine'    
      case('lin')
        self % activation => lin
        self % activation_prime => lin_prime
        self % activation_str = 'lin'
      case default
        self % activation => sigmoid
        self % activation_prime => sigmoid_prime
        self % activation_str = 'sigmoid'
